...
{green}│    {white}          ██║░░██║██║░╚███║██║░╚███║██║██╔╝╚██╗{green}                     │
{green}│     {white}         ╚═╝░░╚═╝╚═╝░░╚══╝╚═╝░░╚══╝╚═╝╚═╝░░╚═╝{green}                     │
{green}│                  {green}   Paid tools  Not for Free                    {green}       │
{green}╰────────────────────────────────────────────────────────────────────────╯

 {white}┌──{red}[ {hotpink} AUTHOR/OWNER {red} ]
 {white}╰────── {green}❯{yellow}❯{purple}❯{white}❯ {yellow} Joaquin Laurier  """)
...
def main():
    ...
    print(f"""                 {lightblue}OVERVIEW OF STORED ACCOUNT & PAGES💫
                            ...
                            {red}FRA ACCOUNT{yellow} : {green}{total_accounts}
                            {red}FRA PAGES  {yellow} : {green}{total_pages}
                            {red}RPW ACCOUNT{yellow} : {green}{ total_account_rpw}
                            {red}RPW PAGES  {yellow} : {green}{total_pages_rpw}
{hotpink}┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓\033[0m""")
    print(f"{hotpink}┃                 {light_magenta}   𝐓 𝐎 𝐎 𝐋 𝐒   𝐒 𝐄 𝐑 𝐕 𝐈 𝐂 𝐄 𝐒                    {hotpink}       ┃")
    print(f"{hotpink}┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛ ")
    print(f"{hotpink}┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓")
    print(f"{hotpink}┃  {white}[01] {red} 𝐒𝐓𝐀𝐑𝐓 𝐓𝐎𝐎𝐋𝐒                          {yellow}- {lightblue}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]    {hotpink}    ┃")
    print(f"{hotpink}┃  {white}[02]  {hotpink}𝐀𝐔𝐓𝐎 𝐑𝐄𝐀𝐂𝐓 𝐏𝐎𝐒𝐓                      {yellow}- {lightblue}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]    {hotpink}    ┃")
    print(f"{hotpink}┃  {white}[03]  {hotpink}𝐀𝐔𝐓𝐎 𝐑𝐄𝐀𝐂𝐓 𝐑𝐄𝐄𝐋𝐒                     {yellow}- {lightblue}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]      {hotpink}  ┃")
    print(f"{hotpink}┃  {white}[04]  {hotpink}𝐀𝐔𝐓𝐎 𝐑𝐄𝐀𝐂𝐓 𝐆𝐑𝐎𝐔𝐏 𝐏𝐎𝐒𝐓                {yellow}- {lightblue}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {hotpink}   ┃")
    print(f"{hotpink}┃  {white}[05]  {hotpink}𝐀𝐔𝐓𝐎 𝐑𝐄𝐀𝐂𝐓 [ 𝐕𝐈𝐃𝐄𝐎 𝐎𝐑 𝐏𝐇𝐎𝐓𝐎 ]        {yellow}- {lightblue}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {hotpink}   ┃")
    print(f"{hotpink}┃  {white}[06]  {hotpink}𝐀𝐔𝐓𝐎 𝐅𝐎𝐋𝐋𝐎𝐖                          {yellow}- {lightblue}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]       {hotpink} ┃")
    print(f"{hotpink}┃  {white}[07]  {hotpink}𝐀𝐔𝐓𝐎 𝐑𝐄𝐀𝐂𝐓 𝐃𝐏/𝐏𝐎𝐒𝐓                   {yellow}- {lightblue}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]    {hotpink}    ┃")
    print(f"{hotpink}┃  {white}[08]  {hotpink}𝐀𝐔𝐓𝐎 𝐂𝐎𝐌𝐌𝐄𝐍𝐓𝐒                        {yellow}- {lightblue}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {hotpink}   ┃")
    print(f"{hotpink}┃  {white}[09]  {hotpink}𝐀𝐔𝐓𝐎 𝐅𝐎𝐋𝐋𝐎𝐖 & 𝐋𝐈𝐊𝐄 𝐏𝐀𝐆𝐄              {yellow}- {lightblue}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]    {hotpink}    ┃")
    print(f"{hotpink}┃  {white}[10]  {hotpink}𝐀𝐔𝐓𝐎 𝐒𝐇𝐀𝐑𝐄 [ 𝐕𝐈𝐀 𝐂𝐎𝐎𝐊𝐈𝐄𝐒 ]           {yellow}- {lightblue}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]      {hotpink}  ┃")
    print(f"{hotpink}┃  {white}[11]  {hotpink}𝐀𝐔𝐓𝐎 𝐑𝐄𝐀𝐂𝐓 𝐂𝐎𝐌𝐌𝐄𝐍𝐓𝐒                  {yellow}- {lightblue}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {hotpink}   ┃")
    print(f"{hotpink}┃  {white}[12]  {hotpink}𝐀𝐔𝐓𝐎 𝐑𝐄𝐏𝐋𝐘 𝐂𝐎𝐌𝐌𝐄𝐍𝐓𝐒                  {yellow}- {lightblue}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {hotpink}   ┃")
    print(f"{hotpink}┃  {white}[13]  {hotpink}𝐀𝐔𝐓𝐎 𝐑𝐄𝐀𝐂𝐓 𝐏𝐎𝐒𝐓 ( 𝐖/𝐂𝐀𝐑𝐄 )           {yellow}- {lightblue}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {hotpink}   ┃")
    print(f"{hotpink}┃  {white}[14]  {hotpink}𝐀𝐔𝐓𝐎 𝐆𝐑𝐎𝐔𝐏 𝐉𝐎𝐈𝐍                      {yellow}- {lightblue}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {hotpink}   ┃")
    print(f"{hotpink}┃  {white}[15]  {hotpink}𝐀𝐔𝐓𝐎 𝐑𝐄𝐀𝐂𝐓 𝐋𝐈𝐕𝐄 𝐒𝐓𝐑𝐄𝐀𝐌               {yellow}- {lightblue}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {hotpink}   ┃")
    print(f"{hotpink}┃  {white}[16]  {hotpink}𝐀𝐔𝐓𝐎 𝐂𝐎𝐌𝐌𝐄𝐍𝐓 𝐋𝐈𝐕𝐄 𝐒𝐓𝐑𝐄𝐀𝐌             {yellow}- {lightblue}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔??𝐓 ]     {hotpink}   ┃")
    print(f"{hotpink}┃  {white}[17]{hotpink}  𝐑𝐄𝐒𝐄𝐓 𝐓𝐎𝐎𝐋𝐒                          {yellow}- {lightblue}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]      {hotpink}  ┃")
    print(f"{hotpink}┃  {white}[18]{hotpink}  𝐀𝐔𝐓𝐎 𝐂𝐑𝐄𝐀𝐓𝐄 𝐏𝐀𝐆𝐄                     {yellow}- {lightblue}[ 𝐏𝐇 𝐍𝐀𝐌𝐄 ]          {hotpink}      ┃")
    print(f"{hotpink}┃  {white}[19] {hotpink} 𝐀𝐔𝐓𝐎 𝐒𝐄𝐓 𝐏𝐅𝐎𝐅𝐈𝐋𝐄                     {yellow}- {lightblue}[ 𝐑𝐀𝐍𝐃𝐎𝐌 ]             {hotpink}    ┃")
    print(f"{hotpink}┃  {white}[20] {hotpink} 𝐂𝐑𝐄𝐀𝐓𝐄 𝐅𝐈𝐋𝐄                          {yellow}- {lightblue}[ 𝐑𝐀𝐍𝐃𝐎𝐌 ]            {hotpink}     ┃")
    print(f"{hotpink}┃  {white}[21] {hotpink} 𝐑𝐄𝐌𝐎𝐕𝐄 𝐃𝐔𝐏𝐋𝐈𝐂𝐀𝐓𝐄                     {yellow}- {lightblue}[ 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 𝐑𝐄𝐌𝐎𝐕𝐄𝐑 ]    {hotpink}    ┃")
    print(f"{hotpink}┃  {white}[22]  {hotpink}𝐀𝐂𝐂𝐎𝐔𝐍𝐓 𝐂𝐇𝐄𝐂𝐊𝐄𝐑                      {yellow}- {lightblue}[ 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 𝐂𝐇𝐄𝐂𝐊𝐄𝐑 ]  {hotpink}      ┃")
    print(f"{hotpink}┃  {white}[23]  {hotpink}𝐕𝐀𝐋𝐈𝐃𝐀𝐓𝐄 𝐓𝐎𝐊𝐄𝐍                       {yellow}- {lightblue}[ 𝐓𝐎𝐊𝐄𝐍 ]             {hotpink}     ┃")
    print(f"{hotpink}┃  {white}[24]  {hotpink}𝐑𝐄𝐃𝐄𝐄𝐌 𝐀𝐂𝐂𝐎𝐔𝐍𝐓                       {yellow}- {lightblue}[ 𝐑𝐄𝐃𝐄𝐌𝐓𝐈𝐎𝐍𝐒 ]      {hotpink}       ┃") 
    print(f"{hotpink}┃  {white}[25]  {hotpink}𝐀𝐔𝐓𝐎 𝐒𝐇𝐀𝐑𝐄 𝐕1                        {yellow}- {lightblue}[ 𝐅𝐀𝐒𝐓 𝐒𝐏𝐄𝐄𝐃 / 𝐏𝐑𝐈𝐕𝐀𝐓𝐄 ] {hotpink}  ┃") 
    print(f"{hotpink}┃  {white}[26]  {hotpink}𝐀𝐔𝐓𝐎 𝐒𝐇𝐀𝐑𝐄 𝐕2                        {yellow}- {lightblue}[ 𝐅𝐀𝐒𝐓 𝐒𝐏𝐄𝐄𝐃 / 𝐏𝐔𝐁𝐋𝐈𝐂 ]   {hotpink} ┃") 
