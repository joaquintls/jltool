...
───────────────────────────────────────────────────────────────────
   ...
   {red}                          ██╗██╗██╗██╗
          ...
          {white}  DEVELOPER      :  J O A Q U I N
          {white}  TOOL       :  \x1b[1;31m  APPROVAL-SYSTEM
           {white} VERSION    :  {yellow} 7.0

\x1b[1;37m                  KEY   :  {key}
{yellow}───────────────────────────────────────────────────────────────────""")
        print("'\x1b[1;31m' YOU NEED APPROVAL TO USE THIS TOOL")
        time.sleep(0.5)
        urls = [
            "https://github.com/jltool05060730/jl/blob/main/Approval.txt",
        ]        
        for url in urls:
            ...
            if key in approval_data:
                ...
                time.sleep(3)
                return key        
        print("\x1b[1;37mSEND KEY ON MESSENGER")
        linex()
        input("\x1b[1;37mCLICK ENTER TO SEND YOUR KEY")
        tks = f"HELLO SIR! PLEASE APPROVED MY TOKEN: {key}"
        approval_url = f"https://www.facebook.com/yvonne.howell.142?message={tks}"
...
{blue}│     {hotpink}          ░░░╚═╝░░░╚═╝╚═╝░░╚═╝░╚═════╝░╚═════╝░                {blue}      │
{blue}│                                                                 {blue}         │
{blue}╰──────────────────{C} D E V E L O P E R  S Y T H E {blue}──────────────────────────╯
 ╭────────{C}TOOL INFORMATION{B}─────────╮ {blue}   ╭────────{C}USER INFORMATION{B}─────────╮
 │ {red}•{hotpink} OWNER   : {green}Joaquin     {blue}    │   {blue} │ {red}• {hotpink}STATUS   : {green}ACTIVE        {blue}     │
 │{red} • {hotpink}USES    : {green}BOOSTING       {blue}     │ {blue}   │ {red}• {hotpink}COUNTRY  :{green} PHILIPPINES    {blue}    │
 │{red} • {hotpink}NETWORK : {green}ALL NETWORK     {blue}    │   {blue} │ {red}• {hotpink}TELEGRAM : {green}@joaquinzo         {blue}  │
...
def main():
    ...
    print(f""" {yellow}┃                        {hotpink} ACCOUNT STORAGE               {yellow}                  ┃""")
    print(f""" {yellow}┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛   
                               {green} ACCOUNT{yellow} : {green}{total_accounts} """)

                            
    print(f"{yellow}┏━━━━━━━━━━━━━━━━━━━━━━ {hotpink}T O O L  S E R V I C E S{yellow} ━━━━━━━━━━━━━━━━━━━━━━━━━━┓")
    print(f"{yellow}┃  {green}[01] {hotpink} STORE ACCOUNT                        {yellow}- {green}[ 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]   {yellow}             ┃")
