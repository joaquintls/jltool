...
{gh}│                                                                     {gh}     │
{gh2}│    ╭────────────────────────────────────────────────────────────────╮{gh2}    │
{gh2}│    │ {h}           ░████{h2}██╗██╗{h3}░░██╗{h4}░████{h5}█╗░████{h6}██╗░███████╗{gh2}            │   {gh2} │
{gh2}│    │  {h}          ██╔════╝{h2}██║░{h3}░██║█{h4}█╔══█{h5}█╗██╔══{h6}██╗██╔════╝ {gh2}           │ {gh2}   │
{gh3}│    │{h}            ╚█████╗░██{h2}███{h3}██║██{h4}█████{h5}║██████╔{h6}╝█████╗░░{gh3}            │ {gh3}   │
{gh3}│    │ {h}           ░╚═══██╗██╔{h2}══█{h3}█║██╔{h4}══██║{h5}██╔══██╗{h6}██╔══╝░░{gh3}            │  {gh3}  │
{gh4}│    │  {h}          ██████╔╝██║░░{h2}██{h3}║██║░{h4}░██║█{h5}█║░░██║█{h6}██████╗{gh4}            │  {gh4}  │
{gh4}│    │  {h}          ╚═════╝░╚═╝░░╚{h2}═╝{h4}╚═╝░░{h4}╚═╝╚═╝{h5}░░╚═╝╚══{h6}════╝{gh5}            │  {gh5}  │
{gh5}│    ╰────────────────────────────────────────────────────────────────╯  {gh2}  │
{gh5}│                                                                     {gh5}     │
{gh6}╰──────────────────────────────────────────────────────────────────────────╯
{gh4} ╭────────{gh}TOOL INFORMATION{gh4}─────────╮ {gh4}   ╭────────{gh2}USER INFORMATION{gh4}─────────╮
{gh4} │ {red}•{hotpink} OWNER   : {h}Joaquin L         {gh4}    │   {gh4} │ {red}• {hotpink}STATUS   : {h}ACTIVE        {gh4}     │
{gh5} │{red} • {hotpink}USES    : {h}BOOSTING       {gh5}     │ {gh5}   │ {red}• {hotpink}COUNTRY  :{h} PHILIPPINES    {gh5}    │
 {gh5}│{red} • {hotpink}NETWORK : {h}ALL NETWORK     {gh5}    │   {gh5} │ {red}• {hotpink}TELEGRAM : {h}@joaquinzo         {gh6}  │
...
def main():
    ...
    jovan()
    print(f""" {gh4}┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓\033[0m""")
    print(f""" {gh4}┃                        {gh} ACCOUNT STORAGE               {gh4}                  ┃""")
    print(f""" {gh4}┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛   
                           {green} ACCOUNT{yellow} : {green}{total_accounts} """)

                            
    print(f"{gh}┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓")
    print(f"{gh2}┃                {h}[{h6}01/A{h}] {gh3} STORE YOUR {green}ACCOUNT                   {gh2}             ┃")
    print(f"{gh2}┃                {h}[{h6}02/B{h}]  {gh3}VALIDATE {green}ACCOUNT                     {gh2}             ┃")
    print(f"{gh3}┃                {h}[{h6}03/C{h}]  {gh4}AUTO SHARE {green}( BOT )                   {gh3}             ┃") 
    print(f"{gh4}┃                {h}[{h6}04/D{h}]  {gh4}AUTO SHARE {green}( NOTIFY )                       {gh4}      ┃") 
    print(f"{gh5}┃                {h}[{h6}05/E{h}]{gh5}  RESET {green}TOOLS                                     {gh5}  ┃")
    print(f"{gh6}┗━━━┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛\033[0m")
